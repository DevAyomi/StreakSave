            ...
            <div className="hero-section">
              ...
              >
                ...
                <h1 className="hero-title">
                  NO <span className="highlight-box">COMPLEXITY</span> JUST SECURE <span className="text-primary">SAVINGS</span> <span className="text-primary">GATEWAY</span> FOR WEB3
                </h1>
